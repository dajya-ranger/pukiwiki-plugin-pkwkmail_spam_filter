...
function PKWKMAIL_formmaker($attr,$cnfm)
{
	...
	$result_form .= '<script type="text/javascript" src="https://code.jquery.com/jquery-2.1.4.min.js"></script>' . "\n";
	$result_form .='<div class="g-recaptcha" data-callback="enableBtn" data-sitekey="' . SPAM_FILTER_RECAPTCHA_SITEKEY . '"></div>' . "\n";
	$result_form .='<script type="text/javascript">' . "\n";
